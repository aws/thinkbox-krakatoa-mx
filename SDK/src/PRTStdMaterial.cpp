...
/**
 * @file PRTStdMaterial.cpp
 *
 * @note This file is a legacy transplant from KrakatoaMX. It is the header and source file combined and exposed via a
 * factory function.
 */
#include "stdafx.h"
...
ApplyStdMaterial( boost::shared_ptr<frantic::particles::streams::particle_istream> pin, Mtl* pMtl,
                  const frantic::max3d::shaders::renderInformation& renderInfo, bool doShadeColor,
                  bool doShadeAbsorption, bool doShadeEmission, bool doShadeDensity, TimeValue t ) {
    if( pMtl != NULL && ( doShadeColor || doShadeAbsorption || doShadeEmission || doShadeDensity ) )
        pin.reset( new MaxKrakatoaStdMaterialIStream( pin, pMtl, renderInfo, doShadeColor, doShadeAbsorption,
                                                      doShadeEmission, doShadeDensity, t ) );
